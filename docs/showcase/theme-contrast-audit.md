...
- Keep the strengthened timeline border and rail values because they communicate timeline structure outside the component package contract.
...
- Showcase borders and inputs inherit the exact component package tokens: light border `oklch(0.9 0 0)`, light input `oklch(0.92 0 0)`, dark border `oklch(0.28 0 0)`, and dark input `oklch(0.3 0 0)`. This fidelity takes precedence over applying a showcase-only 3:1 boundary treatment; focus rings and forced-color outlines remain independently reinforced.
