...
- 2026-07-11: Implemented #391 on `feature/issue-391-dark-theme-focus` after measuring all twelve brand/theme combinations. Secondary text already passed; border, input, amber-light ring, and dark destructive pairs were below their targets.
...
- 2026-07-11: Reopened #391 after post-integration review found that the strengthened showcase border gave a false impression of component styling. Removed the showcase-specific border and input overrides, restored the package tokens for every preview and documentation surface, and retained the improved text, action, focus-ring, timeline, and forced-color treatments.
