...
- 2026-07-11: Reopened #391 after post-integration review found the strengthened global border too visually assertive on catalog cards. Kept the accessible input, focus, and forced-color boundaries intact while reducing only the decorative catalog-card border to 70% opacity.
