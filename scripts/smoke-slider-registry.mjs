...
createRoot(document.getElementById("root")!).render(<><Slider label="Numeric" defaultValue={20}/><Slider<[number, number]> label="Range" defaultValue={[20,80]} size="xl"/><Slider label="Steps" mode="stepper" steps={[{value:0,label:"Off"},{value:5,label:"On"}]} defaultValue={5}/>${expressive ? '<ExpressiveSlider label="Expressive" defaultValue={40}/>' : ""}</>);
`,
);
await writeFile(
