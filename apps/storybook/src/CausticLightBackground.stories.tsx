...
import { DethinkProvider, CausticLightBackground } from "@dethink/components";

const meta = {
  title: "Backgrounds/CausticLightBackground",
...
} satisfies Meta<typeof CausticLightBackground>;
export default meta;
