...
import { DethinkProvider, ContourFieldBackground } from "@dethink/components";

const meta = {
  title: "Backgrounds/ContourFieldBackground",
...
} satisfies Meta<typeof ContourFieldBackground>;
export default meta;
