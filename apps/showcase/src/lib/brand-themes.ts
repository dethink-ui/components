...
export const brandThemes: BrandTheme[] = [
  { id: "teal", label: "Teal", swatch: "oklch(0.51 0.1 185)" },
  { id: "violet", label: "Violet", swatch: "oklch(0.5 0.19 295)" },
  { id: "rose", label: "Rose", swatch: "oklch(0.55 0.19 15)" },
  { id: "amber", label: "Amber", swatch: "oklch(0.75 0.15 78)" },
  { id: "ocean", label: "Ocean", swatch: "oklch(0.51 0.15 245)" },
  { id: "forest", label: "Forest", swatch: "oklch(0.52 0.12 150)" },
];
