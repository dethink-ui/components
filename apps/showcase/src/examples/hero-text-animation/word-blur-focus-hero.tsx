  ...
  return (
    <HeroTextAnimationProvider>
      ...
      >
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col px-5 py-20 @min-[480px]/hero:px-8 @min-[900px]/hero:py-28">
          ...
          <HeroTextAnimation
            ...
            className="font-heading text-foreground mt-8 max-w-2xl text-[clamp(1.875rem,5.5cqi,3.75rem)] leading-[1.05] font-semibold tracking-tight text-balance"
          />
          ...
          <div className="mt-9 flex flex-col flex-wrap gap-3 @min-[480px]/hero:flex-row @min-[480px]/hero:items-center">
            <Button asChild size="lg" rightIcon={<ArrowRight />}>
              <a href="#installation-heading">Book a session</a>
            </Button>
            <a
        ...
        <div className="border-border text-muted-foreground relative flex items-center justify-between border-t px-5 py-3.5 text-xs tracking-[0.18em] uppercase @min-[480px]/hero:px-8">
